...
//                 <h2 className="mb-4 text-gradient-warning">Loan Calculator</h2>
...
export default function LoanApp() {
  ...
  const processSteps = [
    ...
    { title: "Loan Approval", description: "Instant approval decision" },
    {
      ...
      description: "Fast fund transfer to account",
    },
  ];
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="loan-hero bg-gradient-primary text-white py-5">
        <Container className="text-center">
          <h1
            className="display-4 fw-bold mb-3 animate-slide-up"
            style={{ fontSize: "clamp(2rem, 4vw, 3.5rem)" }}
          >
            Smart Loans For <span className="text-warning">Bright Futures</span>
          </h1>
          <p
            className="lead mb-4 text-light-1"
          ...
          <Link href="/loan-apply" passHref>
            <Button
              variant="warning"
              size="lg"
              className="rounded-pill px-4 fw-bold shadow-lg hover-scale block text-dark font-medium ripple"
      ...
      <section className="py-5 bg-light-2">
        <Container>
          <Row className="mb-4 text-center">
            <Col>
              <h2
                className="display-5 fw-bold mb-3 text-dark-1"
                style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}
              >
                How It Works
              </h2>
              <p
                ...
                style={{ fontSize: "clamp(1.1rem, 2.2vw, 1.3rem)" }}
              >
                Simple 4-step approval process
              </p>
            </Col>
          </Row>
          <Row className="g-4 process-steps">
                ...
                <div className="position-relative">
                  ...
                  <Card className="h-100 border-0 shadow-sm text-center p-3 p-md-4 hover-scale">
                    <Badge
                      pill
                      bg="warning"
                      className="fs-5 mb-2 mb-md-3 mx-auto number-badge"
                    >
                      {index + 1}
                    </Badge>
                    <Card.Body className="p-2 p-md-3">
                      <Card.Title
                        className="fw-bold mb-2 mb-md-3 text-dark-1"
                        style={{ fontSize: "clamp(1.1rem, 2.2vw, 1.3rem)" }}
                      >
                        {step.title}
                      </Card.Title>
