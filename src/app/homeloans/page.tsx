      ...
      <Container fluid className="py-6 mt-15 mx-5 bg-white">
        ...
        >
          ...
          <Col md={6} className="text-center text-md-start px-4 mt-2">
            ...
            >
              Own Tomorrow’s <br /> Home,
               Funded Today 
              <br /><span style={{ color: "#0d53b7" }}>by Prefinn</span>
            </h1>
          </Col>
        ...
        >
          ...
          <Row className="g-0 justify-content-center mb-4">
            {[
              ...
              { label: "Interest", value: "8.35%", subtext: "Interest Rates" },
              { label: "Finance ", value: "130+", subtext: "From Lenders" },
            ].map((stat, index) => (
              <Col xs={12} md={3} key={index} className="text-center">
                <div className="d-flex flex-column gap-1">
                  <p
                    className="mb-0 text-secondary"
                    style={{ fontSize: "0.9rem", fontWeight: "500" }}
